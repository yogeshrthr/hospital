...
<div class="row">
           ...
           <?php if (!empty($print_details[0]['print_header'])) { ?>
            ...
            <div class="card">
                <div class="card-body">  
                    <div class="row">
                        <div class="col-md-6">                          
                            <p><span class="font-bold"><?php echo $this->lang->line('bill_no'); ?>: </span> <?php echo $this->customlib->getSessionPrefixByType('radiology_billing').$head_result->id; ?></p>
      ...
      <?php echo "(".$row['short_name'].")"; ?>
                             ...
                             <tbody>
                               <?php
                          $row_counter=1;
                            foreach ($result[$row['id']]['radiology_parameter'] as $parameter_key=> $parameter_value) {
                              $row_cls="";
                              if($parameter_value->reference_range < $parameter_value->radiology_report_value)
                                {
                                  $row_cls="bold";
                                }
                        ...
                        $row_counter++;
                            ...
                            <?php if($parameter_value->radiology_result!=""){ ?> 
                        <tr> <td colspan="4"><p><span class="font-bold"><?php echo $this->lang->line('result'); ?>: </span> <?php echo nl2br($parameter_value->radiology_result); ?></p></td></tr>                             
                        <?php
                        }  ?>
