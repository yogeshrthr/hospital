                      ...
                      $row_counter=1;
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?php echo $parameter_value->reference_range." ".$parameter_value->unit_name; ?></td>
                             <td class="text-center"><?php if($parameter_value->radiology_report_value!="" ) {  echo $parameter_value->radiology_report_value." ".$parameter_value->unit_name; } ?></td> 
                        ...
                        <tr> <td colspan="5"><p><b><?php echo $this->lang->line('result'); ?>: </b> <?php echo nl2br($parameter_value->radiology_result); ?></p></td></tr>                             
                            <?php
                            }
