                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo nl2br($value['symptoms']); ?></td>                                                   
                                                        ...
                                                        <?php  } } ?>
                                                    <td class="pull-right">
                                                        <a href='javascript:void(0)' data-loading-text='<i class=\"fa fa-circle-o-notch fa-spin\"></i>' data-opd-id=" <?php echo $value["opdid"]?> "  data-record-id="<?php echo $value["id"] ?>" class='btn btn-default btn-xs print_visit_bill'  data-toggle='tooltip' title=''><i class='fa fa-file'></i></a>
