            ...
            <div class="col-md-12">
                ...
                <div class="">
                    ...
                    <table width="100%" class="printablea4">
                        <tr>
                            <th><?php echo $this->lang->line('prescription'); ?>: <?php echo $this->customlib->getPatientSessionPrefixByType('ipd_prescription').$result->prescription_id; ?></th> <td></td>
                    ...
                    <table width="100%" class="printablea4">
                        ...
                        <?php if($result->symptoms !=''){ ?>
                            ...
                            <b><?php echo $this->lang->line("symptoms"); ?></b>:<br><?php echo nl2br($result->symptoms)  ?></td>
                        <?php } ?>
