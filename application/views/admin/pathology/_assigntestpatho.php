                ...
                <div class="table-responsive">
                    <table class="table tableover table-striped table-bordered table-hover tablefull12 tblProducts mb5" id="tableID">
                        ...
                        <tr id="row1">
                            ...
                            <td>
                                 <button type="button"  class="closebtn delete_rows" data-row-id="1" autocomplete="off"><i class="fa fa-remove"></i></button>
                            </td>
                        </tr>
                    </table>
                                ...
                                <div class="">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div><select name='consultant_doctor' style="width:100%;" id="consultant_doctor" onchange="get_Docname(this.value)" class="form-control consultant_doctor select2" 
 style="width:100%"  >
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" placeholder="Discount"  onkeyup="get_percentage(this.value)" value="0" name="discount" id="discount" style="width: 50%; float: right" class="form-control discount"/></td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td class="pull-right text-right ipdbilltable">
