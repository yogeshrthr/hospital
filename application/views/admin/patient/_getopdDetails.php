        ...
        <div class="table-responsive">
            <table class="table mb0 table-striped table-bordered examples tablelr0space noborder">
                ...
                <tr> 
                    ...
                    <td width="35%"><span id="old_patient"><?php echo $this->lang->line($result['patient_old']); ?></span>
                    </td>
                ...
                <tr>                    
                    ...
                    <td width="35%"><span id="known_allergies"><?php echo $result['visit_known_allergies'] ?></span>
                    </td>
                </tr>
                <tr>                   
