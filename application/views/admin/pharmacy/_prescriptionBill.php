...
?>
 <?php
 if(!empty($prescription_data) && !empty($prescription_data->medicines) ){
?>
...
foreach ($prescription_data->medicines as $medicine_key => $medicine_value) {
   ...
   <tr id="row<?php echo $row_value;?>">
    ...
    <input type="hidden" class="quantity" value="">
                        ...
                        ?>
         <option value="<?php echo $med_cat_value["id"]; ?>" <?php echo set_select('medicine_category_id_<?php echo $row_value;?>', $med_cat_value['id'], ($med_cat_value["id"] == $medicine_value->medicine_category_id) ? TRUE :FALSE); ?>><?php echo $med_cat_value["medicine_category"] ?>
                          </option>
                      <?php 
                  }
                      ?>
