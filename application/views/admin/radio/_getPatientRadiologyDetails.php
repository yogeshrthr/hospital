                    ...
                    <tr>
                        ...
                        <td class="text-left">
                            <?php if(!empty($report_value->collection_specialist_staff_employee_id)){
                                ...
                                ?>
                                </label><br/><label for=""><?php echo $this->lang->line('radiology'); ?> : </label><?php    echo $report_value->radiology_center; ?><br/><?php echo $this->customlib->YYYYMMDDTodateFormat($report_value->collection_date); 
                            }  ?></td>
    ...
    ?>
      <a href='javascript:void(0)'  data-loading-text='<i class="fa fa-circle-o-notch fa-spin"></i>' data-record-id='<?php echo $report_value->id;?>' class='btn btn-default btn-xs add_report' data-toggle='tooltip' title='<?php echo $this->lang->line('add_edit_report'); ?>' ><i class='fa fa-flask'></i></a><?php
                            ...
                            <?php if($report_value->radiology_report != ""){ ?>
                                <a href="<?php echo site_url('admin/radio/downloadReport/'.$report_value->id) ?>" class='btn btn-default btn-xs'><i class="fa fa-download"></i></a>
                            <?php } ?>
                        </td>                            
                    </tr>                               
                    <?php
