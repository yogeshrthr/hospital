...
?>
<input type="hidden" name="radiology_billing_id" value="<?php echo $radiology_data->id; ?>">
              <div class="row">
...
<tr id="row<?php echo $total_rows;?>">
 ...
 <input type="hidden" name="inserted_id_<?php echo $total_rows;?>" value="<?php echo  $report_value->id;?>">
                                                <select class="form-control test_name select2" style="width:100%" onchange="gettestradiodetails(this.value, 1)" name='test_name_<?php echo $total_rows;?>'>
                                                    <option value="<?php echo set_value('test_name_id'); ?>"><?php echo $this->lang->line('select') ?>
                                                    </option>
                                                <?php foreach ($testlist as $dkey => $dvalue) { ?>
                                                        <option value="<?php echo $dvalue["id"]; ?>" <?php echo set_select('test_name_'.$total_rows,$dvalue["id"], ($report_value->radiology_id == $dvalue["id"]) ? TRUE : FALSE); ?>><?php echo $dvalue["test_name"]." (".$dvalue["short_name"].")"; ?>
                                                        </option>
                                                    <?php }?>
                                                </select> 
                                            ...
                                            <td>
                                                 <button type="button"  class="closebtn delete_row" data-row-id="<?php echo $total_rows;?>" autocomplete="off"><i class="fa fa-remove"></i></button>
                                            </td>
                                        </tr>
<?php 
$total_rows++;
                                    ...
                                    <a class="btn btn-info addplus-xs add-record" data-added="0"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add') ?></a> 
                                </div>
...
if ((isset($radiology_data->doctor_id)) && ($radiology_data->doctor_id == $dvalue["id"])) {
    echo "selected";
}
                                    ...
                                    <div class="col-sm-6">
                                        <table class="printablea4">
                                            <tr>
                                                ...
                                                <input type="text" placeholder="Total" value="<?php echo $radiology_data->total; ?>" name="total" id="total" style="width: 30%; float: right" class="form-control total"/></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-right ipdbilltable">
                                                    ...
                                                    <input type="text" placeholder="Discount" name="discount_percent" id="discount_percent" value="<?php echo $radiology_data->discount_percentage; ?>" onchange="addTotal()" class="form-control discount_percent" style="width: 70%; float: right;font-size: 12px;"/></td>
                                                <td class="text-right ipdbilltable">
                                        <input type="text" placeholder="Discount" value="<?php echo $radiology_data->discount; ?>" name="discount" onkeyup="get_percentage(this.value)" id="discount" style="width: 50%; float: right" class="form-control discount"/></td>
                                            </tr>
                                            <tr>
                                                <th><?php echo $this->lang->line('tax') . " (" . $currency_symbol . ")"; ?></th>
                                                <td></td>
                                                <td class="text-right ipdbilltable">
                                                    <input type="text" placeholder="Tax" name="tax" value="<?php echo $radiology_data->tax; ?>" id="tax" style="width: 50%; float: right" class="form-control tax"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th><?php echo $this->lang->line('net_amount') . " (" . $currency_symbol . ")"; ?></th>
                                                <td colspan="2" class="text-right ipdbilltable">
                                                    <input type="text" placeholder="Net Amount" value="<?php echo $radiology_data->net_amount; ?>" name="net_amount" id="net_amount" style="width: 30%; float: right" class="form-control net_amount"/></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div><!--./row-->
